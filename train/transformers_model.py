...
for MODEL_TYPE, MODEL_NAME in MODELS:
    for language in LANGUAGES:
        ...
        test_pred, f1_score, oof_pred = bert_model.model(train, test, params, N_FOLDS, MODEL_NAME, MODEL_TYPE, LB_HACK)
        ...
        # test_pred.to_csv(f"{DATA_PATH}languages/test_{language}_{MODEL_NAME}.csv")
        # oof_pred.to_csv(f"{DATA_PATH}languages/train_{language}_{MODEL_NAME}.csv")
